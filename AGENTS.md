...
| `mcp/server.py` | Zero-dependency MCP stdio server — 16 tools (5 core fix set + 11 branch skills incl. self_heal / heal_hooks / watchdog_status) callable by ANY MCP-capable agent |
